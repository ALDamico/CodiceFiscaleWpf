...
namespace ALD.LibFiscalCode.Persistence.Importer.CsvDataConverters
{
     ...
     */
    public class AnprPlaceMap : ClassMap<Place>
    {
        public AnprPlaceMap()
        {
            ...
            base.Map(p => p.Province)
                .ConvertUsing(r => ProvinceAbbreviationToProvinceMapping[r.GetField("SIGLAPROVINCIA")])
                .Name("SIGLAPROVINCIA");
            base.Map(p => p.Code).Name("CODCATASTALE");
            base.Map(p => p.Region).ConvertUsing(r => ProvinceAbbreviationToRegionMapping[r.GetField("SIGLAPROVINCIA")])
                .Name("SIGLAPROVINCIA");
        ...
        private static readonly Dictionary<string, string> ProvinceAbbreviationToProvinceMapping =
        ...
        private static readonly Dictionary<String, String> ProvinceAbbreviationToRegionMapping =
            new Dictionary<string, string>
            {
                {"AG", "Sicilia"},
                {"AL", "Piemonte"},
